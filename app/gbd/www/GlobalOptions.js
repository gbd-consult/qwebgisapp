...
// @gbd: use this to reroute server requests to the python backend
//var serverAndCGI = "/_gbd_.cgi";
...
var defaultIdentificationMode = "topMostHit"; // or allLayers or activeLayers
...
// @gbd: set the map option dynamically
var project_map = Gbd.option('project.map');
...
// @gbd: set the CRS dynamically
var authid = Gbd.option('project.authid');
...
// LayerOptions.tileClass = Gbd.TileImage;
...
// @gbd: use OSM for the overview layer
overviewLayer = new OpenLayers.Layer.OSM();
